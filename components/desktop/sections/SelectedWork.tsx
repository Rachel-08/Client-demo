...
function CategoryCard({
  ...
  return (
    <motion.article
      ...
      onClick={onClick}
      className="group snap-start min-w-[78vw] shrink-0 cursor-pointer md:min-w-[38vw] md:max-w-[38vw]"
      whileTap={{ scale: 0.98 }}
    >
      {/* Image container */}
...
export default function SelectedWork({
  ...
  return (
    ...
    >
      ...
      {/* Category carousel */}
      {/* 1. Outer Wrapper handles Framer Motion positioning and animation */}
<motion.div
  className="pointer-events-auto absolute bottom-0 left-0 z-60 w-full md:bottom-16"
  style={{
    x: carouselX,
    opacity: carouselOpacity,
  }}
>
  {/* 2. Inner Container handles clean, native horizontal scrolling */}
  <div
    className="w-full flex snap-x snap-mandatory overflow-x-visible gap-4 px-4 pb-8 sm:gap-6 sm:px-6 md:px-10 md:pb-0"
