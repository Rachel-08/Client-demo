...
export default function StudioLanding({
  ...
  return (
    <motion.section
      ...
      className={`absolute inset-0 z-[50] flex flex-col items-center justify-center overflow-hidden bg-[#f5f2eb] px-5 pt-16 sm:px-6 sm:pt-20 ${
    ...
    >
      ...
      <motion.div
        ...
        className="
          mt-9 flex items-center justify-center gap-4
      ...
      >
        ...
        <motion.button
          ...
          className="
            ...
            rounded-full border-none bg-[#1a1208]
            size-[74px] cursor-pointer
            sm:h-auto sm:w-auto sm:rounded-[10px]
            sm:px-8 sm:py-4
            lg:px-9
          "
          style={{
      ...
      className="
        group relative flex items-center justify-center overflow-hidden
        rounded-full border border-[rgba(26,18,8,0.28)] bg-transparent
        size-[74px] cursor-pointer pointer-events-auto z-30
        sm:h-auto sm:w-auto sm:rounded-[10px]
        sm:px-8 sm:py-4 lg:px-9 select-none
      "
      style={{
        fontFamily: "inherit",
      }}
